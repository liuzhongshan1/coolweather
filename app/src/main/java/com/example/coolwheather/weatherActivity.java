...
import com.example.coolwheather.gson.Forecast;
...
public class weatherActivity extends AppCompatActivity {
    ...
    public void requestWeather(final String weatherId){
        String weatherUrl = "http://guolin.tech/api/weather?cityid="+weatherId+"&key=413057a9e5bd48b898777a68e7b22f14";
        Toast.makeText(weatherActivity.this,weatherUrl, Toast.LENGTH_SHORT).show();
